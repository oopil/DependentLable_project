...
def parse_args() -> argparse:
    ...
    parser.add_argument('--label_type',                     default='binary', type=str) # onehot binary huffman
    ...
    parser.add_argument('--noise_augment',                  default=0.1, type=float) # the number means the standard deviance of random noise
